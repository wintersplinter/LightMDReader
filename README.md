...
10. Choose a theme from the theme menu.
11. Choose a PDF paper size.
12. Choose **Export PDF** to open the browser print dialog and save the rendered document as a PDF.
...
The **Download** button stays non-destructive. It saves the current Markdown text, including editor changes, as a new timestamped file.
